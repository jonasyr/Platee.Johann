...
public sealed class OutlookEnvironment
{
    ...
    /// <summary>Initializes a new instance reading the current user's registry.</summary>
    public OutlookEnvironment()
        : this(ReadUseNewOutlook, () => Type.GetTypeFromProgID("Outlook.Application") is not null)
    {
    }
    ...
    public OutlookEnvironment(Func<int?> readUseNewOutlook, Func<bool> classicRegistered)
    {
